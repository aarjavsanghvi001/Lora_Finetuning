...
base_model = r"I:\llama\TinyLlama-1.1B-intermediate-step-1431k-3T"
guanaco_dataset = r"C:\Users\TMHAAS31\Documents\guanaco-llama2-1k"
...
trainer.model.save_pretrained(r'I:\llama\llama-1.1B-chat_guanaco/'+new_model)
trainer.tokenizer.save_pretrained(r'I:\llama\llama-1.1B-chat_guanaco/'+new_model)
